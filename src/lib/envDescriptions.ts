...
const vars: Record<string, string> = {
  ...
  CODEX_HOME: "ai",
  CODEX_API_KEY: "ai",
  CODEX_ACCESS_TOKEN: "ai",
  CODEX_SQLITE_HOME: "ai",
  ANTHROPIC_API_KEY: "ai",
  ANTHROPIC_BASE_URL: "ai",
  ANTHROPIC_MODEL: "ai",
  ANTHROPIC_AUTH_TOKEN: "ai",
  CLAUDE_CODE_AUTO_CONNECT_IDE: "ai",
  DISABLE_TELEMETRY: "ai",
  GEMINI_API_KEY: "ai",
  GOOGLE_API_KEY: "ai",
  ANTIGRAVITY_API_KEY: "ai",
  HF_TOKEN: "ai",
  HF_HOME: "ai",
  OLLAMA_HOST: "ai",
  OLLAMA_MODELS: "ai",
  ...
  MISTRAL_API_KEY: "ai",
  COHERE_API_KEY: "ai",
  LANGCHAIN_API_KEY: "ai",
  LANGCHAIN_TRACING_V2: "ai",
};
