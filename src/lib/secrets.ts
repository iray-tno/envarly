...
const SECRET_KEYWORDS = [
  ...
  "PRIVATE_KEY", "ACCESS_KEY", "AUTH_KEY", "SIGNING_KEY", "CREDENTIAL",
  "WEBHOOK", "DSN", "AUTH_TOKEN",
];
...
const VALUE_PATTERNS: Array<{ regex: RegExp } & SecretInfo> = [
  ...
  { regex: /^(AKIA|ASIA|AROA|AIDA|AIPA|ANPA|ANVA|APKA)[A-Z0-9]{16}$/, service: "AWS", label: "AWS Access Key ID" },

  // Google Cloud — OAuth short-lived access tokens (ya29. prefix)
  { regex: /^ya29\.[A-Za-z0-9_-]{100,}$/,     service: "Google Cloud",   label: "GCP OAuth Access Token" },
  ...
  { regex: /^SG\.[A-Za-z0-9_-]{22}\.[A-Za-z0-9_-]{43}$/, service: "SendGrid", label: "SendGrid API Key" },
