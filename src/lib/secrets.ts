...
const EXACT: Record<string, SecretInfo> = {
  ...
  CODEX_API_KEY: { service: "Codex", label: "Codex API Key" },
  CODEX_ACCESS_TOKEN: { service: "Codex", label: "Codex Access Token" },
  ANTHROPIC_API_KEY: { service: "Anthropic", label: "Anthropic API Key" },
  ANTHROPIC_AUTH_TOKEN: { service: "Anthropic", label: "Anthropic Auth Token" },
  GEMINI_API_KEY: { service: "Google", label: "Gemini API Key" },
  GOOGLE_API_KEY: { service: "Google", label: "Google API Key" },
  ANTIGRAVITY_API_KEY: { service: "Antigravity", label: "Antigravity API Key" },
  HF_TOKEN: { service: "Hugging Face", label: "Hugging Face Token" },
  GROQ_API_KEY: { service: "Groq", label: "Groq API Key" },
  DEEPSEEK_API_KEY: { service: "DeepSeek", label: "DeepSeek API Key" },
  MISTRAL_API_KEY: { service: "Mistral", label: "Mistral API Key" },
  COHERE_API_KEY: { service: "Cohere", label: "Cohere API Key" },
  LANGCHAIN_API_KEY: { service: "LangChain", label: "LangChain API Key" },
...
const SERVICE_PREFIXES: Array<{ prefix: string } & SecretInfo> = [
  ...
  { prefix: "CODEX_", service: "Codex", label: "Codex credentials" },
  { prefix: "ANTHROPIC_", service: "Anthropic", label: "Anthropic credentials" },
  { prefix: "ANTIGRAVITY_", service: "Antigravity", label: "Antigravity credentials" },
  { prefix: "DEEPSEEK_", service: "DeepSeek", label: "DeepSeek credentials" },
  { prefix: "GROQ_", service: "Groq", label: "Groq credentials" },
  { prefix: "MISTRAL_", service: "Mistral", label: "Mistral credentials" },
  { prefix: "COHERE_", service: "Cohere", label: "Cohere credentials" },
  { prefix: "LANGCHAIN_", service: "LangChain", label: "LangChain credentials" },
  { prefix: "HF_", service: "Hugging Face", label: "Hugging Face credentials" },
